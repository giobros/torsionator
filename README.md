...
<img width="8793" height="11568" alt="1" src="https://github.com/user-attachments/assets/71bbacc6-20d0-4b09-8da3-bfe6487bd7ea" />
...
PDB_FILE_NAME_ROOT="NAME"        # CHANGE THIS! file NAME of your PDB file, without .<format>
PDB_FILE_DIR="your_folder_path"  # CHANGE THIS! folder (full path) that contains $PDB_FILE_NAME_ROOT.<format>
...
Look at container/run_example.sh for a "real" case example, where the input .pbd (fragment.pdb) used is located in folder example/, same folder where Torsionator generated its outputs . Other format are supported (SDF, MOL2, MOL, XYZ).
