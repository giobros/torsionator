...
def _build_parser() -> argparse.ArgumentParser:
    ...
    p.add_argument(
        "-m", "--multiplicity", type=int, choices=[0, 1, 2, 3, 4, 6, 8, 9, 12], default=6,
    ...
    p.add_argument(
        ...
        help="Net charge of the molecule (default: 0). MACE ignores charge in NNP calculation; forwarded to GAFF2.",
    )
    p.add_argument(
        "--spin", type=int, default=1,
        help="Spin multiplicity of the molecule (default: 1). MACE ignores spin in NNP calculation; forwarded to GAFF2.",
    )
    return p
